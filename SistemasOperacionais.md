...
>
> ### Estrutura do Linux
> _Mas o que é Linux? Kernel, utilitários, etc._
...
>
> **Árvore**: o sistema contém apenas um diretório Raiz (root), e todos os outros estão "dentro" da raiz.
...
> [!NOTE]
> ### Conceitos de usuário e senha, sistema multiusuário e proteção
> - O UNIX e o Linux incorporam o conceito de multiusuário, onde cada um deve ter acesso restrito aos recursos.
...
> - `su` / `sudo`: entra no modo superusuário.
> - `ls`: lista os arquivos e diretórios.
> - `mkdir`: cria um diretório.
> - `rm`: remove arquivos.
> - `rm -r`: remove diretórios e seus conteúdos de forma recursiva.
...
> [!NOTE]
> ### Classificações
   - **Desktop**: Sistemas voltados para uso pessoal em estações de trabalho.
